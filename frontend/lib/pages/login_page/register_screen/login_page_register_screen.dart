                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 10,),
                                          MCHTextField(hint: 'Павлов Петр Евгеньевич',),
                                          SizedBox(height: 20,),
                                          Text('Email'),
                                          SizedBox(height: 10,),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 10,),
                                          MCHTextField(hint: 'ИП с НДС',),
                                          SizedBox(height: 20,),
                                          Text('Название организации'),
                                          SizedBox(height: 10,),
                                          MCHTextField(hint: 'ИП “Петр Евгеньевич  Павлов”',),
                                          SizedBox(height: 20,),
                                          Text('Должность'),
                                          SizedBox(height: 10,),
                                          MCHTextField(hint: 'Генеральный директор',),
                                          SizedBox(height: 20,),
                                          Text('Номер телефона'),
                                          SizedBox(height: 10,),
